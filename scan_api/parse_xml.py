...
filter = {
    "level_white_list": ["high", "medium","low","informational"],  # High, medium, low, informational four levels.
    "bug_black_list": [            # Vulnerability blacklist, filter out some holes with high hazard level but useless
...
if __name__ == '__main__':
    target_id = "target_id"
    reporturl = "https://localhost:13443/#/reports/hash.xml"
